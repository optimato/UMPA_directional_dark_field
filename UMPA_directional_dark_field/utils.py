...
def generate_rgb(gauss_properties, log_scale=False):
    ...
    magnitude = np.sqrt((gauss_properties[:,:,0]**2 + gauss_properties[:,:,1]**2)/2)

    #directionality = 1- ((gauss_properties[:,:,1]**2) / (gauss_properties[:,:,0]**2))
    directionality = np.sqrt(abs(gauss_properties[:,:,1]**2 - (gauss_properties[:,:,0]**2))/(gauss_properties[:,:,1]**2 + (gauss_properties[:,:,0]**2)))
